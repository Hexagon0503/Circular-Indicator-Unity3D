...
public class IndicatorManager : MonoBehaviour 
{
    ...
    /// 
    /// </summary>
    private Dictionary<string, IndicatorData> runtimeIndicators = new Dictionary<string, IndicatorData>();
    ...
    public void AddIndicator(IndicatorData info)
    {
    ...
    void UpdateIndicators()
    {
        ...
        //
        foreach (IndicatorData indicator in runtimeIndicators.Values)
        {
            ...
            {
                indicator.runtimeUI.UpdateDistance(Vector3.Distance(playerPos.position, indicator.Direction));
            }

            //
            Vector3 forward = playerPos.forward;
            Vector3 rhs = indicator.Direction - playerPos.position;
            ...
            indicator.runtimeUI.SetAngle(angle);
        }
    }
    #endregion
    ...
    /// <param name="info"></param>
    /// <returns></returns>
    public IndicatorUIBase SpawnIndicatorUI(IndicatorData info)
    {
